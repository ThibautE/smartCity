...
import hmin202.smart.thibaut.smartcity.R;
...
public class WeatherFunction {
    ...
    public static JSONObject getJSON(Context context, String city){
        try{
            ...
            connection.addRequestProperty("x-api-key", context.getString(hmin202.smart.thibaut.smartcity.R.string.weatherAPIKey)); //Ajout la clef de l'api contenu dans les ressources
